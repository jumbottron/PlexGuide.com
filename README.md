...
```bash
curl -o /tmp/install.sh https://raw.githubusercontent.com/plexguide/PlexGuide.com/v11/mods/install/install.sh && chmod +x /tmp/install.sh /pg/scripts/menu.sh && /tmp/install.sh && /pg/scripts/menu.sh
```
